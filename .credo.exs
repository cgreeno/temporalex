    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          ## Consistency Checks
          #
          # Disabled: exception names follow Temporal's cross-SDK terminology
          # (ActivityFailure, ChildWorkflowFailure, Nondeterminism, ...), which
          # matters more than an Error suffix convention.
          ...
          #
          # Depth 3 keeps three-segment references (Temporalex.Workflow.API,
          # Temporalex.Core.*) legal — they read fine and aliasing them inside
          # `quote` blocks would leak aliases into user modules.
          ...
          # arity is dictated by the native interface.
          {Credo.Check.Refactor.FunctionArity,
           [files: %{excluded: ["lib/temporalex/native.ex"]}]},
